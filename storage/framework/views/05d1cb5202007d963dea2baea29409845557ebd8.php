            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarApp">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="#features">new</a></li>
                        <li><a class="nav-link" href="#screenshots">show</a></li>
                        
                        <li><a class="nav-link" href="#pricing">Pricing</a></li>
                        <li><a class="nav-link" href="#testimonials">information</a></li>
                        <li><a class="nav-link" href="<?php echo e(('re')); ?>">sign in</a></li>
						<li><a class="nav-link" href="<?php echo e(('apps')); ?>">contact us</a></li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="big-tagline">
                        <h2>Book Our Daily Shows</h2>
                        <p class="lead">


Welcome to the official website of the Sound and Light Show Company، Egypt. Our shows provide you with a learning experience about ancient Egypt and its significant beginning. During our shows, Egyptian Pharaohs rise to narrate their stories of reign and achievements. It is an experience not to be missed when visiting Egypt.
!</p>
    ...
    <div id="features" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Pyramids Show</h3>
                <p class="lead">Pyramids Show

Take a trip to the ancient times, with the Pyramid Sound and Light show. By booking the Sound Light show pyramids you will be provided a ticket to a journey back to thousands of years ago to bring back the Egyptian legacy to life! Thousands of years have passed since the pharaohs
Price
Regular : $19 VIP : $23 CHD : $11 </p>
            </div><!-- end title -->
...
Visit the largest open-air museum in the world “Karnak Temple” in Luxor and attend the fascinating Karnak Sound and Light show. Book the ticket to the show and you will know the secrets behind naming it “Thebes” in ancient times, which holds the most significant ...
Price
Regular : $19 CHD : $11 .</p>
							</div>
...
Edfu is a temple is located in Edfu, 779 KM away from Cairo. This temple distinguished by its huge construction and magnitude. Edfu temple is considered the only temple that survived history and kept its good condition. The engravings on the wall narrate legendary stories such as ...
Price
Regular : $16 CHD : $10 </p>
							</div>
						</li><!-- .highlight .left-row -->
...
Travel through history and discover the secret behind the name Philae. Philae comes from the ancient Egyptian word (Pilak) which stands for “The Remote” place. By booking a ticket to the Philae Sound and Light show you will guarantee yourself an unforgettable experience. A ...
Price
Regular : $19 CHD : $11 </p>
							</div>
						</li><!-- .highlight .left-row -->
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 right-row">
					<ul class="features-right">
						<li class="highlight rhgh" data-index="4">
							...
							<div class="fr-inner">
								<h4>Abu Simbel Show</h4>
								<p>

Do not miss your chance to book Abu Simbel Sound and Light show! The magnificent temple at Abu Simbel which is considered the most recognized symbol of ancient Egypt leaves various questions behind. Abu Simbel is located 280 KM from Aswan on the west bank of the Nile in which was ...
Price
Regular : $19 CHD : $11 </p>
							</div>
						</li><!-- .highlight .left-row -->
    ...
    <div class="how-its-work clearfix">
        <div class="hc colon1">
            <h2>1</h2>
            <h3>torist</h3>
            <p class="lead">The number of tourists in Egypt stood at 0.1 million in 1951. Tourism became an important sector of the economy from 1975 onwards, as Egypt eased visa restrictions for almost all European and North American countries and established embassies in new countries like Austria, Netherlands, Denmark and Finland</p>
        </div><!-- end col -->

        <div class="hc colon2">
            <h2>2</h2>
            <h3>next</h3>
            <p class="lead">In 1976, tourism was a focal point of the Five Year Plan of the Government, where 12% of the budget was allocated to upgrading state-owned hotels, establishing a loan fund for private hotels, and upgrading infrastructure (including road, rail, and air connectivity) for major tourist centres along with the coastal areas.</p>
        </div><!-- end col -->

        <div class="hc colon3">
            <h2>3</h2>
            <h3>next</h3>
            <p class="lead"> tourism experts and advisors were brought in from Turkey and several new colleges were established with Turkish help between 1979 and 1981, to teach diploma courses in hospitality and tourism management. The tourist inflow increased to 1.8 million in 1981 and then to 5.5 million in 2000..</p>
        </div><!-- end col -->  

        <div class="hc colon4">
            <h2>4</h2>
            <h3>next</h3>
            <p class="lead">Tourists arrivals reached a pinnacle in 2010 by reaching 14.7 million visitors.[2][4] Revenues from tourism reached the highest point at $12.6 billion in the fiscal year 2018-2019. </p>
        </div><!-- end col -->  
            ...
            <div class="row text-center">
                <div class="col-md-7 col-sm-12">
                    <div class="customwidget text-left">
                        <h1>sound $ light</h1>
                        <p>Welcome to the official website of the Sound and Light Show Company، Egypt. Our shows provide you with a learning experience about ancient Egypt and its significant beginning. During our shows, Egyptian Pharaohs rise to narrate their stories of reign and achievements. It is an experience not to be missed when visiting Egypt.</p>
    ...
    <div id="pricing" class="section lb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">welcome in egypt</p>
            </div><!-- end title -->
                                ...
                                <div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        ...
                                        <div class="pricing-table-features">
                                            ...
                                            <p><i class="fa fa-rocket"></i> <strong>Regular : $16</strong></p>
                                            
                                            <p><i class="fa fa-link"></i> <strong> CHD : $10</strong> Domains</p>
                                            <p><i class="fa fa-life-ring"></i> <strong>enjoy with us</strong></p>
                                        </div>
                                        <div class="pricing-table-sign-up">
                                            <a href="<?php echo e(('apps')); ?>" class="btn btn-dark btn-radius btn-brd grd1 effect-1">Order Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        ...
                                        <div class="pricing-table-features">
                                            ...
                                            <p><i class="fa fa-rocket"></i> <strong>Regular : $19</strong></p>
                                            
                                            <p><i class="fa fa-link"></i> <strong>VIP : $23</strong> Domains</p>
                                            <p><i class="fa fa-life-ring"></i> <strong> CHD : $11</strong> </p>
                                        </div>
                                        <div class="pricing-table-sign-up">
                                            <a href="<?php echo e(('apps')); ?>" class="btn btn-dark btn-radius btn-brd grd1 effect-1">Learn More</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        ...
                                        <div class="pricing-table-features">
                                            ...
                                            <p><i class="fa fa-rocket"></i> <strong>Regular : $19</strong></p>
                                            <p><i class="fa fa-database"></i> <strong>VIP : $23</strong> </p>
                                            <p><i class="fa fa-link"></i> <strong>CHD : $11</strong> Domains</p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        <p> Misr Company for Sound and Light is a worldwide company holding Sound and Light shows at the various archeological sites in Egypt (The Pyramids and Sphinx, Karnak Temple, Temple of Philae, The Temple of Abu Simbel - Temple of Edfu)..</p>
                        <p></p>
                    </div><!-- end clearfix -->
                </div><!-- end col -->
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        <ul class="footer-links">
                            <li><a href="https://www.soundandlight.show/en">soundandlight</a></li>
                            


    Abol Hol Square - Nazlet El-Semman
    support@soundandlight.show
    +201553113161
                ...
                <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        <ul class="footer-links">
                            <li><a href="https://www.facebook.com/soundandlightshow"><i class="fa fa-facebook"></i> Facebook</a></li>
                            <li><a href="https://www.linkedin.com/company/soundandlightshow"><i class="fa fa-github"></i> linkedin</a></li>
                            <li><a href="https://twitter.com/soundandlighteg"><i class="fa fa-twitter"></i> Twitter</a></li>
                            <li><a href="https://www.instagram.com/soundandlightshow/"><i class="fa fa-dribbble"></i> instgram</a></li>
                            <li><a href="https://www.youtube.com/channel/UCuCgW8zF6zDnfymZkajdzEg"><i class="fa fa-pinterest"></i> youtube</a></li>
                        </ul><!-- end links -->
                    </div><!-- end clearfix -->
                </div><!-- end col -->
            </div><!-- end row -->
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">                    
                    <p class="footer-company-name"> ©2020 Sound & Light Egypt Show. All Rights Reserved  <a href="#"></a> Design By : Digital Experts 
					<a href="https://www.soundandlight.show/en/show/pyramids-show">pyramids show</a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
...
<?php /**PATH C:\xampp\store\resources\views/welcome.blade.php ENDPATH**/ ?>